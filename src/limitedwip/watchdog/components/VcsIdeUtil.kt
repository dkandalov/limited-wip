...
object VcsIdeUtil {
    private val log = Logger.getInstance(VcsIdeUtil::class.java)

    fun registerBeforeCheckInListener(listener: CheckinListener) {
    ...
    private class DelegatingCheckinHandlerFactory(key: VcsKey, private val listener: CheckinListener) : VcsCheckinHandlerFactory(key) {
